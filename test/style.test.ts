...
describe('正在测试颜色类', () => {
    ...
    describe('生成ASS代码', () => {
        it('普通ass代码', () => {
            const color = new Color(51, 66, 109, 0);
